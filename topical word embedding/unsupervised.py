...
parser.add_argument("--dis_most_frequent", type=int, default=35000, help="Select embeddings of the k most frequent words for discrimination (0 to disable)")#注意default为默认单词数
