    ...
    with io.open(emb_path, 'r', encoding='utf-8', newline='\n', errors='ignore') as f:
        for i, line in enumerate(f):
            if i == 0:
                ...
                word, vect = line.rstrip().split(' ', 1)#输出词对应的所有词向量
                word = word.lower()
...
en_vectors=read_txt_embeddings('G:/vectors-sw.txt')
sw_vectors=read_txt_embeddings('G:/vectors-sw.txt')
...
with open('H:/open_clir/exp_query.txt','w',encoding='utf-8') as wf:
